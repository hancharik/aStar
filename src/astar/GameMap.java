...
public class GameMap implements TileBasedMap {
	...
	public GameMap() {
		// create some test data
                fillArea(0,0,WIDTH,HEIGHT,GRASS);
		...
		//fillArea(20,8,5,3,TREES);
                ...
                fillArea(5,8,1,10,TREES);
                fillArea(9,8,1,10,TREES);
                fillArea(16,8,1,8,TREES);
                fillArea(20,12,1,6,TREES);
                fillArea(25,8,1,10,TREES);
                
                
                fillArea(5,8,10,1,TREES);
                fillArea(9,18,10,1,TREES);
                fillArea(15,8,10,1,TREES);
                fillArea(19,18,4,1,TREES);
                
                
                
                fillArea(12,10,4,1,TREES);
                fillArea(14,13,5,1,TREES);
                
                fillArea(6,22,23,1,WATER);
                
               // fillArea(16,8,10,1,TREES);
               // fillArea(25,8,10,1,TREES);
